...
- Move TYPE_CHECKING-only imports to runtime scope (api_clients)
- Move TYPE_CHECKING-only imports to runtime scope (auth)
- Move TYPE_CHECKING-only imports to runtime scope (clients)
- Move TYPE_CHECKING-only imports to runtime scope (models)
- Move TYPE_CHECKING-only imports to runtime scope (resources, tools)
- Move TYPE_CHECKING-only imports to runtime scope (utils)
- ruff: Disable TCH rule to prevent tc-refs audit regression

## [0.6.3] - 2026-08-31

### Testing

- Fix pydantic forward references in API client request models
- Fix pydantic forward references in financial and room models
...
- opera-cloud-mcp: Bump tool-config pins from 3.13 to 3.14
